...
//        view.bringSubviewToFront(pageControl)
        ...
        let attributedTitle = NSMutableAttributedString(string: "Already have an account? ", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14), NSAttributedString.Key.foregroundColor: UIColor.darkGray])
...
extension GetStartedVC {
    ...
    func createSlides() -> [Slide] {
        ...
        let slide1:Slide = Bundle.main.loadNibNamed("OnboardingSlide", owner: self, options: nil)?.first as! Slide
        ...
        let slide2:Slide = Bundle.main.loadNibNamed("OnboardingSlide", owner: self, options: nil)?.first as! Slide
        ...
        let slide3:Slide = Bundle.main.loadNibNamed("OnboardingSlide", owner: self, options: nil)?.first as! Slide
        ...
        let slide4:Slide = Bundle.main.loadNibNamed("OnboardingSlide", owner: self, options: nil)?.first as! Slide
        ...
        let slide5:Slide = Bundle.main.loadNibNamed("OnboardingSlide", owner: self, options: nil)?.first as! Slide
